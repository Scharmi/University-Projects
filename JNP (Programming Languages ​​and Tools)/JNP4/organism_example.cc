...
int main() {
    ...
    constexpr Omnivore<species_id_t> dog2(dog_id, 13);

    constexpr auto encounter_result2 = encounter(dog, dog2);
    constexpr auto dog1_result = get<0>(encounter_result2);
    constexpr auto dog2_result = get<1>(encounter_result2);
    constexpr auto dog_child = get<2>(encounter_result2);
    static_assert(dog1_result.get_species() == dog_id && dog1_result.get_vitality() == 10);
    static_assert(dog2_result.get_species() == dog_id && dog2_result.get_vitality() == 13);
    static_assert(dog_child->get_species() == dog_id && dog_child->get_vitality() == 11);
